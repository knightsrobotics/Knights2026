...
public class RobotContainer {
    ...
    private final CANSparkMax leftArmMotor = new CANSparkMax(2, MotorType.kBrushless);
    private final CANSparkMax rightArmMotor = new CANSparkMax(3, MotorType.kBrushless);

    private final CANSparkMax feederMotor = new CANSparkMax(4, MotorType.kBrushless);
...
shooterRight.getConfigurator().apply(shooterCfg);
    ...
    private void configureBindings() {
        ...
        // Reset heading on LB (leave as-is)
